## Training and testing codes for SwinIR in the ImagePairs dataset
...
```
Please run the main.py script in BCV002. The models are stored in that machine.

You can run it in test and demo mode. 

You can contact us if you have any doubts!
